...
module.exports.getBalances = function(options) {
  ...
  .then(function(resp) {
    ...
    if (options.currency && options.currency === 'ZXC') {
      return {
...
function adjustQualityForXRP(options) {
  const numeratorShift = (options.pays === 'ZXC' ? -6 : 0)
  const denominatorShift = (options.gets === 'ZXC' ? -6 : 0)
